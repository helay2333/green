...
public class GraceJSONResult<T> {
     ...
     * @return
     */
    public static <T>GraceJSONResult<T> error() {
     ...
     * @return
     */
    public static <T>GraceJSONResult<T> errorMap(Map map) {
     ...
     * @return
     */
    public static <T>GraceJSONResult<T> errorMsg(String msg) {
     ...
     * @return
     */
    public static <T>GraceJSONResult<T> errorTicket() {
     ...
     * @return
     */
    public static <T>GraceJSONResult<T> errorCustom(ResponseStatusEnum responseStatus) {
        return new GraceJSONResult(responseStatus);
    }
    public static <T>GraceJSONResult<T> exception(ResponseStatusEnum responseStatus) {
        return new GraceJSONResult(responseStatus);
    }
