...
public interface VlogMapperCustom {
    ...
    public List<IndexVlogVO> getMyLikedVlogList(String id);

    public List<IndexVlogVO> getMyFollowVlogList(String id);

    public List<IndexVlogVO> getMyFriendVlogList(String id);
